...
class Teacher(models.Model):
    ...
    registration_code = models.CharField(max_length=10, unique=True, verbose_name="Código de Colegiatura")
...
class Contribution(models.Model):
    ...
    class Meta:
        ...
        unique_together = ('teacher', 'month', 'year')   # Evita duplicados
        verbose_name = "Aporte"
    ...
    def save(self, *args, **kwargs):
        if not self.receipt_number:
            # Generar número correlativo: CPPE-2025-0001
